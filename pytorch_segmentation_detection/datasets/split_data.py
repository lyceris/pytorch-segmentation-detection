    ...
    def __init__(self,
        ...
        if root is None:
            ...
            if train:
                ...
                self.root = os.path.expanduser('~/.pytorch-segmentation-detection/datasets/split_data/train')
            else:

                self.root = os.path.expanduser('~/.pytorch-segmentation-detection/datasets/split_data/val')

        self.images_folder = os.path.join(self.root, 'images')
        self.annotation_folder = os.path.join(self.root, 'labels')
